...
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 .corner.fa.fa-user.label.uc {
  color:#000000;
  background: rgba(45, 49, 47, 0)!important;
  letter-spacing: 1px;
...
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886.bord {border-inline: 0px solid #4c121e !important;}

.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 .dots.mini.u-msg {
    text-align: center;
...
.break.light.tab-pane.l7dah1 .active {
  background-image: url(https://up6.cc/2024/10/172929975450891.png);
  background-size: cover;
}
#d2.l7dah1  .label-primary{background-color:#b77c9a!important}#d2.l7dah1  .bg{background-color:#b77c9a!important}#d2.l7dah1  .uzr.d-flex.mm.hmsg{border-radius: 10px 10px 10px;background-color: #3426231f!important;}#dpnl.l7dah1 {background-size: 100%;background-image: url();background-color: #b2b2b2;  }#dpnl.l7dah1  .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.l7dah1  .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.l7dah1  span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
#users.l7dah1  .mini.u-msg{text-align:center;}#dpnl.l7dah1 .bg{background-image:linear-gradient(225deg,#ce96b3 0%,#d091b1 29%,#eec6da 67%,#b77c9a 100%) */}#rooms.l7dah1  .corner.fa.fa-user.label.uc.fa-microphone.label-danger{border-radius: 10px 10px 10px!important}
...
#users.l7dah1  img.ustat {
    ...
    box-shadow: inset 0 0 0 rgb(0 0 0 / 8%), 0 0 2px #f0e91f;
}

#users.l7dah1  img.co{border-radius:  10px 10px 10px!important;transform:rotate(0deg);margin-top:2px!important}
...
.head.d-flex.nosel.bg.fl.l7dah1 {
  border-radius:  10px 0 10px!important;
  border: 1px solid #f1f1f1;
  background-image: url(https://up6.cc/2024/10/172930027035561.png);
...
.rsave.btn.btn-primary.fr.l7dah1 , .fa.fa-send.sndpm.fl.btn.btn-primary.l7dah1 , .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary.l7dah1 , .fr.fa.fa-share-alt.sndfilebc.fl.btn.btn-primary.l7dah1 , .bdel.corner.btn.minix.btn-primary.fa.fa-times.l7dah1 , .fa.fa-send.sndbc.fl.btn.btn-primary.l7dah1  {
